...
minetest.register_on_mods_loaded(function()
    for name in pairs(minetest.registered_entities) do
        ...
        "draconis:fire_dragon" then table.insert(target_list, name) end
    end
end)
...
minetest.register_entity("draconis:fire_eyes", {
    ...
    textures = {"draconis_fire_eyes.png"},
    is_visible = true,
            ...
            if parent.status ~= "sleeping" then
                ...
                if parent.age < 25 then
                    self.object:set_properties(
                        {textures = {"draconis_fire_eyes_child.png"}})
                else
                    self.object:set_properties(
                        {textures = {"draconis_fire_eyes.png"}})
                end
...
minetest.register_entity("draconis:fire_dragon", {
    -- Stats
    max_hp = 650,
    ...
    springiness = 0,
    -- Visual
    collisionbox = {-1.95, -2.7, -1.95, 1.95, 1.95, 1.95},
    visual_size = {x = 35, y = 35},
    visual = "mesh",
    mesh = "draconis_fire_dragon.b3d",
    textures = {
        "draconis_fire_dragon_black.png", "draconis_fire_dragon_bronze.png",
        "draconis_fire_dragon_green.png", "draconis_fire_dragon_red.png"
    },
    child_textures = {
        "draconis_fire_dragon_black_child.png",
        "draconis_fire_dragon_bronze_child.png",
        "draconis_fire_dragon_green_child.png",
        "draconis_fire_dragon_red_child.png"
    },
    animation = {
    ...
    on_rightclick = function(self, clicker)
        ...
        if item == "draconis:growth_essence_fire" then
            draconis.increase_age(self)
        end
        mob_core.nametag(self, clicker)
        draconis.set_bone_rot(self, clicker)
        draconis.set_bone_pos(self, clicker)
    end,
