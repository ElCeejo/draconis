...
for string, hex in pairs(fire_colors) do
	minetest.register_craftitem("draconis:scales_fire_dragon_" .. string, {
    ...
    table.insert(dragon_drops, "draconis:scales_fire_dragon_" .. string)
end

for string, hex in pairs(ice_colors) do
	minetest.register_craftitem("draconis:scales_ice_dragon_" .. string, {
		description = "Ice Dragon Scales \n" .. infotext(string, true),
		inventory_image = "draconis_dragon_scales.png^[multiply:#" .. hex,
		groups = {dragon_scales = 1}
	})
    table.insert(dragon_drops, "draconis:scales_ice_dragon_" .. string)
end
...
for string, hex in pairs(fire_colors) do
    minetest.register_node("draconis:egg_fire_" .. string, {
        ...
        on_timer = function(pos)
            ...
            for i = 1, #burn_check do
                ...
                if burning == 8 then
                    minetest.add_entity(pos, "draconis:egg_fire_dragon_" .. string)
    ...
    table.insert(dragon_eggs, "draconis:egg_fire_" .. string)

    creatura.register_mob("draconis:egg_fire_dragon_" .. string, {
        -- Stats
        max_health = 10,
        ...
        activate_func = function(self, staticdata, dtime)
            ...
            self.color = string
            if string == "black" or self.color == "light_blue" then
                self.tex_no = 1
            elseif string == "bronze" or self.color == "sapphire" then
                self.tex_no = 2
            elseif string == "green" or self.color == "slate" then
                self.tex_no = 3
            elseif string == "red" or self.color == "white" then
                self.tex_no = 4
            elseif string == "gold" or self.color == "silver" then
                self.tex_no = 5
            end
        end,
...
for string, hex in pairs(ice_colors) do
    minetest.register_node("draconis:egg_ice_" .. string, {
        ...
        on_timer = function(pos)
            ...
            for i = 1, #burn_check do
                ...
                if burning == 8 then
                    minetest.add_entity(pos, "draconis:egg_ice_dragon_" .. string)
                    minetest.remove_node(pos)
                    break
                end
            end
    ...
    table.insert(dragon_eggs, "draconis:egg_ice_" .. string)

    creatura.register_mob("draconis:egg_ice_dragon_" .. string, {
        -- Stats
        max_health = 10,
        armor_groups = {immortal = 1},
        despawn_after = false,
        ...
        activate_func = function(self, staticdata, dtime)
            ...
            self.owner_name = self:recall("owner_name") or ""
            self.color = string
            if self.color == "light_blue" then
                self.tex_no = 1
            elseif self.color == "sapphire" then
                self.tex_no = 2
            elseif self.color == "slate" then
                self.tex_no = 3
